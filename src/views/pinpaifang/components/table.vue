<template>
	<el-table :data="list" border @selection-change = "select" @row-click="rowClick" height="100%" @sort-change="sort">
		...
		<el-table-column prop="Addr"    label="所在地" show-overflow-tooltip></el-table-column>
		<el-table-column prop="SupplyName"    label="关联供应商" show-overflow-tooltip></el-table-column>
	</el-table>
</template>
