<template>
	<el-table :data="list" border @selection-change = "select" @row-click="rowClick" height="100%" @sort-change="sort">
		...
		<el-table-column prop="Code"   label="地级市代码" show-overflow-tooltip></el-table-column>
		<el-table-column prop="Name"   label="地级市名称" show-overflow-tooltip></el-table-column>
    ...
    <el-table-column prop="Name_EN"   label="地级市英文名称" show-overflow-tooltip></el-table-column>
	</el-table>
</template>
