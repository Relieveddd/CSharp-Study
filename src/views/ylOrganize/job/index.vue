...
<script>
import { queryJob } from "@/utils/api";
...
export default {
  ...
  methods: {
    ...
    async onRemove() {
      let rowList = this.tableSelectionData.map(x => x.F_PostId).join();
